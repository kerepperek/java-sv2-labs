...
public class MathLesson {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(adder.getSolution(12, 11));
        System.out.println(subtracter.getSolution(12, 11));
        System.out.println(multiplier.getSolution(12, 11));
        System.out.println(divisor.getSolution(12, 11));
    }
}
