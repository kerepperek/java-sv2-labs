...
public class Plane {
    ...
    public static void main(String[] args) {
        Passenger passenger = new Passenger("John Doe", 115000);
        System.out.println(passenger.getName());
        System.out.println(passenger.getPriceOfPlaneTicket());

        PriorityPassenger priorityPassenger = new PriorityPassenger("Billy Idol", 115000, 20);
        ...
        FirstClassPassenger firstClassPassenger = new FirstClassPassenger("Curt Sewer", 115000, 20);
