...
public class Patient {
    ...
    public Patient(String name, String ssn, int year) {
        ...
        if (!new SsnValidator().isValidSsn(ssn))
            throw new IllegalArgumentException("Hibás azonosító: " + ssn);
        this.name = name;
    ...
    public static void main(String[] args) {
        ...
        Patient patient = new Patient("Kerep Perek", "111111110", 1974);
        patient.printResult(patient);

        patient= new Patient("Kerep Perek", "111111111", 1974);
        patient.printResult(patient);
