...
class BikeAdvertisementTest {
    ...
    void testCreateWithTwoParameters() {
        ...
        assertEquals("Gyerekkori BMX", advertisement.getShortDescription());
    ...
    void testCreateWithThreeParameters() {
        ...
        assertEquals("Női 26-os bicikli", advertisement.getShortDescription());
    ...
    void testCreateWithFourParameters() {
        ...
        assertEquals("20-as gyerek mountain bike", advertisement.getShortDescription());
    ...
    void testCreateWithFiveParameters() {
        ...
        assertEquals("felnőtt férfi hegyi terepbicikli", advertisement.getShortDescription());
