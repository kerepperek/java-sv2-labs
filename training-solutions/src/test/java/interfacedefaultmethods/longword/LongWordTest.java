...
class LongWordTest {
    ...
    @Test
    void testLongWord() {
        LongWord longWord = new LongWord(Paths.get("training-solutions/src/test/resources/longword.txt"));
    ...
    void testLongWordFileIsNotExisting() {
        LongWord longWord = new LongWord(Paths.get("training-solutions/src/test/resources/xyz.txt"));
