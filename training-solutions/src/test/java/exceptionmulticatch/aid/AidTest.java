...
class AidTest {
    ...
    void testCountAmountsOfAid() {
        ...
        assertEquals(expected, aid.countAmountsOfAid(Paths.get("training-solutions/src/test/resources/population1.txt")));
    }
    ...
    void testCountAmountsOfAidWithNotExistingFilename() {
        Exception ex = assertThrows(IllegalStateException.class,
                () -> aid.countAmountsOfAid(Paths.get("training-solutions/src/test/resources/xyz.txt")));
        assertEquals("Something went wrong while counting.", ex.getMessage());
    ...
    void testCountAmountsOfAidWithInvalidLine() {
        Exception ex = assertThrows(IllegalStateException.class,
                () -> aid.countAmountsOfAid(Paths.get("training-solutions/src/test/resources/population2.txt")));
        assertEquals("Something went wrong while counting.", ex.getMessage());
    ...
    void testCountAmountsOfAidWithInvalidNumber() {
        Exception ex = assertThrows(IllegalStateException.class,
                () -> aid.countAmountsOfAid(Paths.get("training-solutions/src/test/resources/population3.txt")));
        assertEquals("Something went wrong while counting.", ex.getMessage());
    ...
    void testCountAmountsOfAidWithZeroNumber() {
        Exception ex = assertThrows(IllegalStateException.class,
                () -> aid.countAmountsOfAid(Paths.get("training-solutions/src/test/resources/population4.txt")));
        assertEquals("Something went wrong while counting.", ex.getMessage());
