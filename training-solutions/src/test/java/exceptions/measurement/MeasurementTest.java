...
class MeasurementTest {
    ...
    void setUp() {
        ...
        measured = measurement.readFromFile(Paths.get("training-solutions/src/test/resources/measurementdata.csv"));
    }
    ...
    void testReadFromNotExistingFile() {
        Exception ex = assertThrows(IllegalStateException.class,
                () -> measurement.readFromFile(Paths.get("training-solutions/src/test/resources/xyz.csv")));
